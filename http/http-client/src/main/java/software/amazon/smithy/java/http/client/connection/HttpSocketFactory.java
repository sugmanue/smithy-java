...
public interface HttpSocketFactory {
    ...
    /**
     * Default factory that creates sockets with TCP_NODELAY=true and SO_KEEPALIVE=true.
     *
     * <p>TCP send and receive buffer sizes are left unset so the kernel can autotune them.
     */
