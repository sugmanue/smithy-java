...
/**
 * Configuration for {@link CrtHttpClientTransport}.
 */
public final class CrtHttpTransportConfig extends HttpTransportConfig {

    private int maxConnectionsPerHost = 20;
    private int h2StreamsPerConnection = 100;
    private Duration acquireTimeout = Duration.ofSeconds(30);
    private int readBufferSize = 16 * 1024 * 1024;

    public int maxConnectionsPerHost() {
        return maxConnectionsPerHost;
    }

    public CrtHttpTransportConfig maxConnectionsPerHost(int value) {
    ...
    public CrtHttpTransportConfig h2StreamsPerConnection(int value) {
    ...
    public CrtHttpTransportConfig acquireTimeout(Duration value) {
    ...
    public CrtHttpTransportConfig readBufferSize(int value) {
        this.readBufferSize = value;
        return this;
    }

    @Override
    public CrtHttpTransportConfig fromDocument(Document doc) {
        ...
        var window = config.get("readBufferSize");
        if (window != null) {
            this.readBufferSize = window.asInteger();
        }
