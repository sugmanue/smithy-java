...
/**
 * Types-only directed codegen. Generates only shapes (structures, enums, unions, etc.)
 * without any client or server code.
 */
@SmithyInternalApi
final class TypesDirectedJavaCodegen
    ...
    TypesDirectedJavaCodegen(Set<CodegenMode> modes) {
        this.modes = modes;
    }
