...
include(":client:client-http-smithy")
include(":client:client-http-boringssl")
include(":client:client-http-netty")
include(":client:client-http-apache")
include(":client:client-http-apache-classic")
include(":client:client-http-crt")
